package com.allan.camvor.services;
...
import com.allan.camvor.activities.driver.NotificationBookingActivity;
import com.allan.camvor.channel.NotificationHelper;
import com.allan.camvor.receivers.AcceptReceiver;
import com.allan.camvor.receivers.CancelReceiver;
...
public class MyFirebaseMessagingClient extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (title != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                if (title.contains("SOLICITUD DE TRASTEO")) {
                ...
                } else if (title.contains("TRASTEO CANCELADO")) {
    ...
    private void showNotificationActions(String title, String body, String idClient) {
        ...
        //Cancelar
        Intent cancelInten = new Intent(this, CancelReceiver.class);
        cancelInten.putExtra("idClient", idClient);

        PendingIntent cancelPendingIntent = PendingIntent.getBroadcast(this,
                NOTIFICATION_CODE, cancelInten,
                PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
