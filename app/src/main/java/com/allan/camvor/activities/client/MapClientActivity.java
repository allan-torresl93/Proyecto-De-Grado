...
import com.allan.camvor.activities.MainActivity;
...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
                ...
                if (getApplicationContext() != null) {
                    ...
                    mMarker = mMap.addMarker(new MarkerOptions().position(
                            new LatLng(location.getLatitude(), location.getLongitude())
                                    ...
                                    .title("Tu Posicion")
                                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_client))
                    );*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonRequestDriver.setOnClickListener(view -> requestDriver());
    ...
    private void instanceAutocompleteOrigin(){
        ...
        mAutocomplete.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                Log.d("PLACE", "Name: " + mOriginLatLng.latitude);
                Log.d("PLACE", "Name: " + mOriginLatLng.longitude);
    ...
    private void instanceAutocompleteDestination(){
        ...
        mAutocompleteDestination.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                Log.d("PLACE", "Name: " + mDestinationLatLng.latitude);
                Log.d("PLACE", "Name: " + mDestinationLatLng.longitude);
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveDrivers(mCurrentLatLng, 10).addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Conductor Disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_truck)));
                marker.setTag(key);
