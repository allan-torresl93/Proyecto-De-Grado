...
public class MapClientBookingActivity extends AppCompatActivity implements OnMapReadyCallback {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (status.equals("start")){
                        mTextViewStatusBooking.setText("Estado: Trasteo Iniciado");
                        startBooking();
                    }
                    else if (status.equals("finish")){
                        mTextViewStatusBooking.setText("Estado: Trasteo Finalizado");
                        finishBooking();
                    }
                }
            }
    ...
    private void startBooking() {
        mMap.clear();
        mMap.addMarker(new MarkerOptions().position(mDestinationLatLng).title("Entregar Aqui").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_pin_red)));
