...
public class NotificationBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMediaPlayer = mMediaPlayer.create(this,R.raw.truck_horn);
        ...
        mbuttonAccept.setOnClickListener(v -> acceptBooking());

        mbuttonCancel.setOnClickListener(v -> cancelBooking());
    }
    ...
    private void checkIfClientCancelBooking(){
        mListener = mClientBookingProvider.getClientBooking(mExtraIdClient).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!snapshot.exists()){
                    Toast.makeText(NotificationBookingActivity.this, "El Cliente Cancelo El Trasteo", Toast.LENGTH_LONG).show();
